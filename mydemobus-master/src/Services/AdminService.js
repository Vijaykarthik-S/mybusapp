...
const API_URL = "https://localhost:7108/api/Admin/users";
const OP_API_URL = "https://localhost:7108/api/Admin/operators";
const BUS_API_URL = "https://localhost:7108/api/Buses";
const ROUTE_API_URL = "https://localhost:7108/api/BusRoute";
